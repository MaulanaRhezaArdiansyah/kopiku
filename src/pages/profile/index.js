            ...
            <div className="lg:flex lg:flex-col lg:gap-y-28">
              ...
              <div className="lg:flex lg:gap-x-5">
                ...
                <div className="action-button w-full lg:w-[40%] h-[28rem] px-8 py-4 flex flex-col gap-5">
                  ...
                  <button
                    type="submit"
                    className="bg-[#6A4029] text-white font-bold flex items-center justify-center w-full py-4 rounded-lg hover:bg-transparent border-[2px] border-[#6A4029] hover:text-[#6A4029]"
                  >
                    Save Changes
                  </button>
                  <button className="bg-amber-400 hover:bg-amber-500 text-[#6A4029] font-bold py-4 flex justify-center items-center w-full rounded-lg">
                    Cancel
                  </button>
