...
// import ContentProductDetails from "../../components/content/ProductDetails";
...
const ProductDetails = () => {
  ...
  const cart = {
    ...
    imageCart: `https://kopiku.up.railway.app/images/${dataProductDetails.images[0].filename}`,
    orderCart: order,
    sizeCart: size,
  ...
  TabTitle(`Kopiku - ${dataProductDetails.title}`);
  return (
    <>
            ...
            <div className="bg-white shadow-xl shadow-slate-300 w-[30%] max-sm:w-full sm:hidden h-full max-sm:h-[20vh] rounded-lg flex flex-col gap-y-2 p-5 items-center justify-center">
              ...
              <div className="flex gap-x-3 w-full lg:px-6  justify-center items-center">
                <button
                  ...
                  className="bg-amber-400 text-lg h-14 w-14 rounded-full flex items-center justify-center font-bold"
                >
                  R
                </button>
