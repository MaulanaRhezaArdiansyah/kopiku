      ...
      <section className="w-7/12 max-sm:w-full h-full max-sm:h-[40%]">
        <section className="footer-about w-4/6 h-full flex flex-col gap-y-5 pt-24 pl-20 max-sm:pt-5 max-sm:pl-5">
          ...
          <div className="flex gap-4">
            <a
              href=""
              className="flex items-center bg-amber-400 p-3 rounded-full"
            >
              <svg
          ...
          <p className="text-[#AFB5C0] line-height-30">
            @{new Date().getFullYear()}Kopiku
          </p>
        </section>
      </section>
      <section className="w-5/12 h-full max-sm:w-full max-sm:h-[60%]">
        <section className="footer-nav w-full h-full pt-24 max-sm:pt-10 max-sm:pl-5 max-sm:pb-10 flex">
          <section className="footer-nav-product w-1/2 flex flex-col gap-3">
          ...
          <section className="footer-nav-engage w-1/2 flex flex-col gap-3">
